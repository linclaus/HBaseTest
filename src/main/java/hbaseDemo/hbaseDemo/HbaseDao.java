...
public class HbaseDao {
	...
	static {
		...
		conf.set("hbase.zookeeper.quorum", "gs-server-v-129,gs-server-v-128,gs-server-v-127");// HBase集群gs-server-1027:2181,gs-server-1028:2181,gs-server-1031:2181,gs-server-1032:2181,gs-server-1033:2181
	}
